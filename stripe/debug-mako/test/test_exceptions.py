...
from test.util import result_lines, indicates_unbound_local_error
...
${foobar}
        ...
        assert '<table class="syntax-highlightedtable">' in \
...
${foobar}
    ...
    def test_tback_no_trace_from_py_file(self):
        ...
        assert indicates_unbound_local_error(html_error, "y")
